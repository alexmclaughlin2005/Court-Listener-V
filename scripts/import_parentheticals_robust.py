#!/usr/bin/env python3
"""
Import parentheticals from CourtListener bulk data CSV with robust parsing

This script uses a custom CSV parser to handle malformed quotes and embedded delimiters.
"""
import os
import sys
import bz2
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Import parentheticals with robust CSV parsing')
            ...
            if len(batch) >= args.batch_size:
                ...
                if total_read % 10000 == 0:
                    logger.info(
                        ...
                        f"{skipped_missing_opinion:,} missing opinion | "
