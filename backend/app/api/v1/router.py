...
from app.api.v1 import citations, search, import_routes, bulk_import, treatment, admin, opinions, citation_sync, ai_analysis, citation_quality
...
api_router.include_router(citation_quality.router, prefix="/citation-quality", tags=["citation-quality"])
